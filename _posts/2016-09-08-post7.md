...
-D mapreduce.input.fileinputformat.split.minsize=xxxx（单位byte），最小拆分大小与blocksize配合使用控制map数量mapreduce.JobSubmitter: number of splits。</br>
参考：<a href="https://hadoop.apache.org/docs/current/hadoop-mapreduce-client/hadoop-mapreduce-client-core/MapReduceTutorial.html#MapReduce_-_User_Interfaces">MapReduce Tutorial</a>
</p>
